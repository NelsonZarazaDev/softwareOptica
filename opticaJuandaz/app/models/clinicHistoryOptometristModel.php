...
{ 
     ...
     function selectHistoryClinic($array)
    {
     ...
     function updateHistory(
        ...
        keratometriadifferential_od='$keratometriadifferential_od',
        keratometriadifferential_oi='$keratometriadifferential_oi',
        ...
        refractionaddition_od='$refractionaddition_od',
        refractionaddition_oi='$refractionaddition_oi',
        ...
        subjectiveadd_od='$subjectiveadd_od',
        subjectiveadd_oi='$subjectiveadd_oi',
