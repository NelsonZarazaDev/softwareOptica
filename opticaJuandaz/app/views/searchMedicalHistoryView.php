...
?>
        ...
        <div class="table-responsive">
            <table class="table table-hover" id="myTable">
                ...
                <tbody>
                    <?php foreach ($array_searchMedicalHistory as $object_history) {
    ...
    function viewClinicHistory($array_secretary_history)
    {
    ?>
            ...
            <div class="card-body">
                <div class=" row row-cols-3 gx-4 gy-2">
                    ...
                    <div class="justify-content-between">
                        ...
                        <input type="text" name="healthcareEntityHistory" id="healthcareEntityHistory" value="<?php echo ($array_secretary_history[0]['healthcare_entity_person']) ?>" class="form-control inputMedicalHistory" disabled>
                    </div>
                    <div class="justify-content-between">
                    ...
                    <div class="justify-content-between">
                        ...
                        <input type="text" name="occupationHistory" id="occupationHistory" value="<?php echo ($array_secretary_history[0]['occupation_person']) ?>" class="form-control inputMedicalHistory" disabled>
                    </div>

                    <div class="d-flex flex-column">
                        <label class="textLabelCreate">Departamento:</label>
                        <input type="text" name="id_department" id="id_department" value="<?php echo $array_secretary_history[0]['name_department'] ?>" class="form-control inputMedicalHistory" disabled>
                    ...
                    <div class="d-flex flex-column mt-3">
                        ...
                        <input type="text" name="id_optometrist" id="id_optometrist" value="<?php echo ($array_secretary_history[0]['name_access']) . " " . ($array_secretary_history[0]['surname_access']) ?>" class="form-control inputMedicalHistory" disabled>
                    </div>

                    <div class="justify-content-between">
                        <label class="textMedicalHistoryLabel">Parentesco acompañante</label>
                        <input type="text" name="relationshipHistory" id="relationshipHistory" class="form-control inputMedicalHistory" value="<?php echo ($array_secretary_history[0]['relationship_companion']) ?>" disabled>
                    </div>
                    <div class="justify-content-between">
                        <label class="textMedicalHistoryLabel">Nombres acompa&ntilde;ante</label>
                        <input type="text" name="nameCompanionHistory" id="nameCompanionHistory" class="form-control inputMedicalHistory" value="<?php echo ($array_secretary_history[0]['name_companion']) ?>" disabled>
                    </div>
                    <div class="justify-content-between">
                        <label class="textMedicalHistoryLabel">Apellidos acompa&ntilde;ante</label>
                        <input type="text" name="surnameCompanionHistory" id="surnameCompanionHistory" class="form-control inputMedicalHistory" value="<?php echo ($array_secretary_history[0]['surname_companion']) ?>" disabled>
                    </div>
                    <div class="justify-content-between">
                ...
                <div class="justify-content-between mt-3 mb-3">
                    ...
                    <textarea name="reasonQueryHistory" id="reasonQueryHistory" cols="10" rows="5" class="form-control inputMedicalHistory" disabled><?php echo ($array_secretary_history[0]['reason_history'])?></textarea>
                </div>

                <div class="row row-cols-3 gx-4 gy-2">
                    <div class="justify-content-between">
                        <label class="textMedicalHistoryLabel">Antecedentes personales</label>
                        <textarea name="personalHistory" id="personalHistory" cols="10" rows="5" class="form-control inputMedicalHistory" disabled ><?php echo ($array_secretary_history[0]['personal_history']) ?></textarea>
                    </div>
                    <div class="justify-content-between">
                        <label class="textMedicalHistoryLabel">Antecedentes oculares</label>
                        <textarea name="OcularBackgroundHistory" id="OcularBackgroundHistory" cols="10" rows="5" class="form-control inputMedicalHistory" disabled><?php echo ($array_secretary_history[0]['ocular_history']) ?></textarea>
                    </div>
                    <div class="justify-content-between">
                        <label class="textMedicalHistoryLabel">Antecedentes familiares</label>
                        <textarea name="familyBackgroundHistory" id="familyBackgroundHistory" cols="10" rows="5" class="form-control inputMedicalHistory" disabled><?php echo ($array_secretary_history[0]['family_history']) ?></textarea>
                    </div>
                </div>
                ...
                <div class="justify-content-between mt-3 mb-3">
                    ...
                    <textarea name="" id="" cols="10" rows="5" class="form-control inputMedicalHistory" disabled><?php echo ($array_secretary_history[0]['observation']) ?></textarea>
                </div>

                <div class="justify-content-between mt-3 mb-3">
                    <label class="textMedicalHistoryLabel">Recomendaciones</label>
                    <textarea name="" id="" cols="10" rows="5" class="form-control inputMedicalHistory" disabled><?php echo ($array_secretary_history[0]['recommendation']) ?></textarea>
                </div>

                <div class="justify-content-between mt-3 mb-3">
                    <label class="textMedicalHistoryLabel">Diagnostico</label>
                    <textarea name="" id="" cols="10" rows="5" class="form-control inputMedicalHistory" disabled><?php echo ($array_secretary_history[0]['diagnostic']) ?></textarea>
                </div>
            </div>
        </div>
<?php
