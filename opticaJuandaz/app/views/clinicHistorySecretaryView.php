            ...
            <form id="formSearch" class="mb-5">
                <div>
                    <div class="input-group position-static align-items-center justify-content-between">
                        <div>
                            <button type="button" class="col-12 buttonCreateHistory align-items-center col-lg-12 p-1 d-flex justify-content-center mb-2 ml-2" onclick="HistoryClinic.modalHistoryClinic();">
