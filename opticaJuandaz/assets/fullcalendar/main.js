...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var ToolbarSection = /** @class */ (function (_super) {
        ...
        ToolbarSection.prototype.render = function () {
            ...
            return createElement.apply(void 0, __spreadArray(['div', { className: 'd-sm-flex fc-toolbar-chunk' }], children));
        };
        ToolbarSection.prototype.renderWidgetGroup = function (widgetGroup) {
            ...
            for (var _i = 0, widgetGroup_1 = widgetGroup; _i < widgetGroup_1.length; _i++) {
                ...
                if (buttonName === 'title') {
                    isOnlyButtons = false;
                    children.push(createElement("h2", { className: "fc-toolbar-title text-center", id: props.titleId }, props.title));
                }
                else {
    ...
    var DayHeader = /** @class */ (function (_super) {
        ...
        DayHeader.prototype.render = function () {
            ...
            return (createElement(NowTimer, { unit: "day" }, function (nowDate, todayRange) { return (createElement("tr", { role: "row" },
                ...
                dates.map(function (date) { return (datesRepDistinctDays ? (createElement(TableDateCell, {date: date, dateProfile: dateProfile, todayRange: todayRange, colCnt: dates.length, dayHeaderFormat: dayHeaderFormat })) : (createElement(TableDowCell, { key: date.getUTCDay(), dow: date.getUTCDay(), dayHeaderFormat: dayHeaderFormat }))); }))); }));
        };
        return DayHeader;
    }(BaseComponent));
    ...
    var MorePopover = /** @class */ (function (_super) {
        ...
        MorePopover.prototype.queryHit = function (positionLeft, positionTop, elWidth, elHeight) {
            ...
            if (positionLeft >= 0 && positionLeft < elWidth &&
                ...
                return {
                    dateProfile: props.dateProfile,
                    dateSpan: __assign({ allDay: false, range: {
        ...
        Table.prototype.queryHit = function (positionLeft, positionTop) {
            ...
            if (row != null && col != null) {
                ...
                return {
                    ...
                    dateSpan: __assign({ range: this.getCellRange(row, col), allDay: false }, cell.extraDateSpan),
    ...
    */
    ...
    BootstrapTheme.prototype.classes = {
        ...
        buttonGroup: 'btn-group row justify-content-evenly',
        button: 'btn-blue',
        buttonActive: 'active',
        popover: 'popover',
